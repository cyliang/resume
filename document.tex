...
\section{Publication (accepted)}
    ...
    \cvlistitem{\textbf{Heterogeneous System Architecture (HSA)} is a hardware architecture proposed for more efficient heterogeneous computing. Built on \textbf{LLVM}, our framework transforms sequential code and generates GPU binary with LLVM's backends. It includes polyhedral dependence checking and a runtime dispatching scheduler. On an AMD Carrizo machine (HSA-compliant), a sequential application running through this framework could be 8.66x faster than before.}
